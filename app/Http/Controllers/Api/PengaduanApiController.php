...
class PengaduanApiController extends Controller
    ...
    ->select('pengaduans.id','user_id','komunitas_id','users.name','users.foto','lokasi_kejadian', 'waktu_kejadian','penyebab_kejadian','status_pengaduan','tanggapan_pengaduan','judul_pengaduan','isi_pengaduan','pengaduans.created_at','pengaduans.updated_at')
