...
class PengaduanApiController extends Controller
{
	public function get_all(){
        ...
        ->select('pengaduans.id','user_id','komunitas_id','users.name','users.foto','judul_pengaduan', 'pengaduan_image','isi_pengaduan','pengaduans.created_at','pengaduans.updated_at')
