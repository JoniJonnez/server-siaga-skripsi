...
class PengaduanApiController extends Controller
    ...
    ->select('pengaduans.id','user_id','users.name','users.foto','status_pengaduan', 'judul_pengaduan','pengaduan_image','isi_pengaduan','pengaduans.created_at','pengaduans.updated_at')
