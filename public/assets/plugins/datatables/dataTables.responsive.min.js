...
(function (c) {
    ...
    var m = c.fn.dataTable,
        j = function (a, b) {
            ...
            this.s = { dt: new m.Api(a), columns: [], current: [] };
    ...
    c.extend(j.prototype, {
        ...
        _columnsVisiblity: function (a) {
            var b = this.s.dt,
                ...
                h = c.map(d, function (b) {
                    return b.auto && null === b.minWidth
                        ? !1
                        : !0 === b.auto
                        ? "-"
                        : -1 !== c.inArray(a, b.includeIn);
                }),
                n = 0;
            e = 0;
        ...
        _classLogic: function () {
            ...
            e.each(function (a, e) {
                for (
                    var d = a.className.split(" "), f = !1, j = 0, l = d.length;
                    j < l;
                    j++
                ) {
                    var k = c.trim(d[j]);
        ...
        _detailsInit: function () {
            ...
            c(b.table().body()).on(
                ...
                function (d) {
                    if (
                        c(b.table().node()).hasClass("collapsed") &&
                        b.row(c(this).closest("tr")).length
                    ) {
                        if (typeof e === "number") {
        ...
        _resize: function () {
            ...
            k &&
                ...
                c(b.table().node()).trigger("responsive-resize.dt", [
                    b,
                    this.s.current,
                ]));
        },
        _resizeAuto: function () {
            ...
            if (
                ...
                c(f)
                    .append(c(a.rows({ page: "current" }).nodes()).clone(!1))
                    .find("th, td")
                    .css("display", "");
                if ((f = a.table().footer())) {
        ...
        _tabIndexes: function () {
            ...
            c(
                "number" === typeof e ? ":eq(" + e + ")" : e,
                a.rows({ page: "current" }).nodes()
            )
        ...
        listHidden: function () {
            return function (a, b, d) {
                return (a = c
                    ...
                    .join(""))
                    ? c('<ul data-dtr-index="' + b + '"/>').append(a)
                    : !1;
            };
        },
        tableAll: function (a) {
            ...
            return function (b, d, e) {
                b = c
                    ...
                    .join("");
                return c(
                    '<table class="' + a.tableClass + '" width="100%"/>'
                ).append(b);
            };
        },
    };
    ...
    o.register("responsive.hasHidden()", function () {
        ...
        return a._responsive
            ? -1 !== c.inArray(!1, a._responsive.s.current)
            : !1;
    });
    j.version = "2.1.0";
    ...
    c(k).on("preInit.dt.dtr", function (a, b) {
        if (
            "dt" === a.namespace &&
            (c(b.nTable).hasClass("responsive") ||
                c(b.nTable).hasClass("dt-responsive") ||
                b.oInit.responsive ||
                m.defaults.responsive)
        ) {
